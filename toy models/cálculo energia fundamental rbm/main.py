...
np.random.seed(42)
rbm.a = np.random.normal(0, 0.01, size=4)
rbm.b = np.random.normal(0, 0.01, size=4)
rbm.W = np.random.normal(0, 0.01, size=(4, 4))
...
def plot_energia_avancada(energia_por_epoca, energia_fci=-1.728379, energia_nuc=0.734):
